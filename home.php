            ...
            <div class="row d-flex align-items-center">
               <div class="col-md-8">
                  <div class="homepage-search-title">
                     <h1 class="mb-2 font-weight-normal"><span class="font-weight-bold">Find Awesome Deals</span> in <?php echo $city;?></h1>
                     <h5 class="mb-5 text-secondary font-weight-normal">Lists of top restaurants, cafes, pubs, and bars </h5>
                  </div>
                  <div class="homepage-search-form">
                      <form class="form-noborder" method="post" action="user_restaurant.php">
                        <div class="form-row">
                           
                           <div class="col-lg-7 col-md-7 col-sm-12 form-group">
                               <select name="rid" class="form-control form-control-lg" >
                                  <option>Select your favorit Restaurant</option>
                                  <?php
                                  $q4="select * from restaurants where r_city='$city';";
                                  $re4=$con->query($q4);
                                  while($r4=$re4->fetch_assoc())
                                  {
                                      ?>
                                  <option  value="<?php echo $r4['rid'];?>"><?php echo $r4['r_name'];?></option>
                                  <?php
                                  }
                                  ?>
                              </select>
